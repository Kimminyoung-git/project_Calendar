...
public class EventController {
	 ...
	 * // 이벤트 목록을 가져오는 API
	 * 
	 * @GetMapping("/api/events") // /calendar/api/events 경로로 이벤트를 조회 public
	 * List<Event> getEvents() { return eventService.getAllEvents(); // 이벤트 목록 반환 }
	 */
	  ...
	  // 새로운 /calendar/eventData 경로로 이벤트 목록을 가져오는 POST 요청
		  ...
		  @PostMapping("/api/events") // 새로운 POST 경로 추가 
